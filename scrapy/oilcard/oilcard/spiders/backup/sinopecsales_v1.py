...
class SinopecsalesSpider(scrapy.Spider):
    ...
    def after_login(self, response):
        ...
        return [FormRequest(url='http://www.sinopecsales.com/gas/webjsp/billQueryAction_compareCard.json',
                            meta={'cookiejar': response.meta['cookiejar']},
                            headers=reqheaders,
                            formdata=post_data,
    ...
    def getViceCardObject(self, response):
        ...
        post_data = {
            'cardMember.cardNo': '1000113700015449964',
            'viceCard': '1000113700015449971'
        }
        reqheaders = {
            'Host': 'www.sinopecsales.com',
            "Accept": "application/json, text/javascript, */*; q=0.01",
    ...
    def transaction_log(self, response):
        post_data = {
            'cardMember.cardNo': '1000113700015449971',
